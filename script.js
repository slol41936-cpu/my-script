(async function () {
  ...
  function f(p2) {
    ...
    if (v5) {
      ...
      if (v11) {
        v5.style.color = "#f87171";
        v5.style.borderColor = "rgba(239, 68, 68, 0.4)";
        v5.style.boxShadow = "inset 0 0 10px rgba(239, 68, 68, 0.1)";
      } else if (v12) {
        v5.style.color = "#34d399";
        v5.style.borderColor = "rgba(52, 211, 153, 0.4)";
        v5.style.boxShadow = "inset 0 0 10px rgba(52, 211, 153, 0.1)";
      } else {
        v5.style.color = "#a855f7";
        v5.style.borderColor = "rgba(168, 85, 247, 0.4)";
        v5.style.boxShadow = "inset 0 0 10px rgba(168, 85, 247, 0.1)";
      }
    }
    if (v3) {
      v3.innerText = p2;
      const v13 = /denied|not found|Error|Stopped|🔴/i.test(p2);
      v3.style.color = v13 ? "#f87171" : "#34d399";
      v3.style.textShadow = v13 ? "0 0 15px rgba(239, 68, 68, 0.7)" : "0 0 15px rgba(52, 211, 153, 0.7)";
    }
  }
