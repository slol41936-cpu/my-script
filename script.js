(async function () {
  ...
  function f(p2) {
    if (v5) {
      v5.innerText = p2;
      const v12 = /denied|not found|Error|Stopped|🔴|someone else|Missed/i.test(p2);
    ...
    if (v3) {
      v3.innerText = p2;
      const v14 = /denied|not found|Error|Stopped|🔴|someone else|Missed/i.test(p2);
  ...
  // ----------------- আল্ট্রা-ফাস্ট ইনস্ট্যান্ট স্নাইপ ইঞ্জিন -----------------
  async function f5(p10, p11) {
    while (v10) {
      try {
        ...
        if (!v27.length) {
          // ডিলে ৩০০ms থেকে কমিয়ে ৩৫ms করা হয়েছে
          await new Promise(r => setTimeout(r, 35));
          continue;
        }

        // রেঞ্জ বা ডিরেক্ট ম্যাচ ফিল্টার
        ...
        for (const v29 of v28) {
          if (!v10) break;
          const actualAmt = Number(v29.amount || p10);
          f("⚡ Sniping ₹" + actualAmt);
          ...
          // beforeBuy পাঠানোর সাথে সাথে buy রিকোয়েস্ট পাইপলাইন প্রস্তুত করা
