  ...
  function f(p2) {
    ...
    if (v5) {
      ...
      if (v11) {
        ...
        v5.style.color = "#ff3b5c";
        v5.style.borderColor = "rgba(255, 59, 92, 0.4)";
        v5.style.boxShadow = "inset 0 0 10px rgba(255, 59, 92, 0.1)";
      }
    }
    if (v3) {
      v3.innerText = p2;
